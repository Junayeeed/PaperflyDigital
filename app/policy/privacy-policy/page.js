...
export default function PrivacyPolicy() {
  return (
    <main style={{ maxWidth: 800, margin: "0 auto", padding: "2rem" }}>
      ...
      <ul>
        <li><strong>Personal Information:</strong> Such as your name, email address, and any other information you voluntarily provide through our contact forms or newsletter sign-ups.</li>
      ...
      <ul>
        ...
        <li>To send you updates, marketing, and promotional materials (if you opt-in)</li>
      ...
      <ul>
        ...
        <li>We may share information with service providers who assist us in operating our website and conducting our business, provided they agree to keep this information confidential.</li>
        <li>We may disclose your information if required by law or to protect our rights and safety.</li>
      </ul>
      <h2>Security</h2>
      <p>
      ...
      <h2>Contact Us</h2>
      <p>
        If you have any questions about this Privacy Policy, please contact us at info@paperflydigital.com.
      </p>
    </main>
  );
}